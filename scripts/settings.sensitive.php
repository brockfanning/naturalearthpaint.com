...
/**
 * @file
 * Example settings.php data for sensitive info.
 *
 * This unusued file is to demonstrate the data that needs to be copied into
 * settings.php and replaced with actual values.
 */
